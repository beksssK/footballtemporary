...
const HomeMiddle = () => {
  const [leftSided, setLeftSided] = useState(true);
  const setSide = () => {
  ...
  return (
    <div className="HomeMiddle container">
      ...
      <InfoSection leftSided={leftSided} sectionClass="who" infoTitle="Who are we"
                   infoText={<><b>HNBM SPORTS AGENCY</b> is an International, standard and global private sports agency;
                     ...
                     details.</>}
      />
      <InfoSection leftSided={false} sectionClass="what" infoTitle="What do we do"
                   infoText={<>
                     <ol>
      ...
      />
      <InfoSection leftSided={leftSided} sectionClass="why" infoTitle="Why do they choose us?"
                   infoText={<>
      ...
      />
      <InfoSection leftSided={false} sectionClass="staff" infoTitle="Our staff"
                   infoText={<>
